 ...
 */
final class Version20190617185603 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE contribution (id INT AUTO_INCREMENT NOT NULL, my_user_id INT NOT NULL, value DOUBLE PRECISION NOT NULL, payment_date DATE NOT NULL, INDEX IDX_EA351E152D977FB9 (my_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE data_format (id INT AUTO_INCREMENT NOT NULL, urodziny DATE DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
