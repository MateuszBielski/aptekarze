 ...
 */
final class Version20190815165349 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE job (id INT AUTO_INCREMENT NOT NULL, replaced_by_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, rate DOUBLE PRECISION NOT NULL, UNIQUE INDEX UNIQ_FBD8E0F89AC69B54 (replaced_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE abstr_member (id INT AUTO_INCREMENT NOT NULL, job_id INT NOT NULL, telephone VARCHAR(64) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, first_name VARCHAR(255) NOT NULL, surname VARCHAR(255) NOT NULL, payment_day_of_month INT DEFAULT NULL, nr_prawa_zawodu VARCHAR(255) DEFAULT NULL, nazwisko_panienskie VARCHAR(255) DEFAULT NULL, begin_date DATE DEFAULT NULL, initial_account DOUBLE PRECISION DEFAULT NULL, discriminator VARCHAR(255) NOT NULL, INDEX IDX_8A6531DBBE04EA9 (job_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE active_job (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, rate DOUBLE PRECISION NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE archive_job (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, rate DOUBLE PRECISION NOT NULL, date_of_change DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE active_job');
